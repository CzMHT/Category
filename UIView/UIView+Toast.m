...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        NSAttributedString *attributedText = [[NSAttributedString alloc] initWithString:title attributes:@{NSFontAttributeName:titleLabel.font}];
        
        CGSize expectedSizeTitle = [attributedText boundingRectWithSize:maxSizeTitle options:NSStringDrawingUsesLineFragmentOrigin context:nil].size;
    ...
    if (message != nil) {
        ...
        NSAttributedString *attributedText = [[NSAttributedString alloc] initWithString:message attributes:@{NSFontAttributeName:messageLabel.font}];
        
        CGSize expectedSizeMessage = [attributedText boundingRectWithSize:maxSizeMessage options:NSStringDrawingUsesLineFragmentOrigin context:nil].size;
